# 📚 AutoKorrektur Documentation Index

Welcome to the AutoKorrektur technical documentation repository.
...
| | [PRIVACY_POLICY.md](../PRIVACY_POLICY.md) | GDPR/DSGVO privacy policy for the published `core` flavor (German, binding); [PRIVACY_POLICY.en.md](../PRIVACY_POLICY.en.md) English. Hosted at https://autokorrektur.org/privacy from [site/](../site/). |
| | [CHANGELOG.md](../CHANGELOG.md) | Release history & version tags. |
| **🧭 Strategy & Roadmaps** | [TODO.md](../TODO.md) | Active milestone roadmap. |
| | [ARCHIVE_TODO.md](ARCHIVE_TODO.md) | Historical archive of completed milestones. |
| | [PERSONAS.md](PERSONAS.md) | Target audience personas & user journeys. |

The optional SDXL cloud service and the desktop ML benchmark live in their own repository:
[konradvoelkel/autokorrektur-backend](https://github.com/konradvoelkel/autokorrektur-backend).
